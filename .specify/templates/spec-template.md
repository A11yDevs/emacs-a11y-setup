...
- **CA-001 Accessibility**: Explain keyboard-only operation and screen-reader-friendly
...
- **CA-005 Diagnostics-first**: Define required doctor/check validations before setup
  mutation.
- **CA-006 Modularity and maintainability**: Identify platform-specific modules,
  extensibility points, and idempotency constraints.
