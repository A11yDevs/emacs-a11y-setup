...
- [ ] T004 Add Constitution compliance checklist artifact for this feature
...
- [ ] T026 [US1] Add accessible diagnostics and remediation hints for story failures
...
- [ ] TXXX Validate Constitution compliance report before merge
- [ ] TXXX Register known limitations and PoC findings for affected platforms/TTS backends
- [ ] TXXX Validate `recommended` mode as default bootstrap path for accessibility
- [ ] TXXX Verify destructive installer/setup commands require explicit confirmation
...
- Include explicit tasks for diagnostics-first and safe rollback when setup mutates host state
- Include tasks that prove personal Emacs config isolation and non-overwrite guarantees
